...
const Auth = () => {
    ...
    return (
        <form onSubmit={submitHandler} className="flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] top-0 left-0 right-0 bottom-0 rounded-lg shadow-xl border border-gray-200 bg-white z-40">
